const notebooksContainer = document.getElementById('plays1');
const notebooksContainer2 = document.getElementById('plays2');

getProducts();

async function getProducts() {
    const responseNotebooks = await fetch('JS/plays.json')
...
function RenderProducts2(arr){
    document.getElementById('plays2').style.display = "none";
...
function Show1(){
    document.getElementById('plays1').style.display = "flex";
    document.getElementById('plays2').style.display = "none";
}
function Show2(){
    document.getElementById('plays2').style.display = "flex";
    document.getElementById('plays1').style.display = "none";
